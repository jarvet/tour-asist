...
#     media_path = url(r'^media/(?P<path>.*)$', staticview.static.serve, {'document_root': settings.MEDIA_ROOT}, name="media")
# else:
#     media_path = url(r'^(?P<path>.*)$', staticview.static.serve, {'document_root': settings.MEDIA_ROOT}, name="media")
